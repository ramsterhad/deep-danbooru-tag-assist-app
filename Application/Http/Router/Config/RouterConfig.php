...
use Ramsterhad\DeepDanbooruTagAssist\Application\Http\Router\Config\Exception\UnknownRouteApplicationException;
...
class RouterConfig
{
    ...
    public function getRouteByAlias(string $alias): Route
    {
        if (!$this->hasAlias($alias)) {
            throw new UnknownRouteApplicationException();
        }
