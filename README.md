...
### predicted_tags_db_url
##### default
````
http://rdtls.nl/ddta/db/
````
##### about
There's a database which already holds predicted tags, generated by the Machine Learning Platform script. Instead of
calculating them live, the database was built beforehand and holds the tags as json. If the configuration parameter is 
set, the app tries to get the information from this database. if it fails, classic MLP service will used.``
